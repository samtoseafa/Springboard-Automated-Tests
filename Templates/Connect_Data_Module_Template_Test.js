...
it("Connect Data Module", function () {
    cy.get(':nth-child(7) > [style="width: 320px; height: 200px; padding: 20px; border-radius: 20px; text-align: center; background-color: rgb(0, 111, 182);"]').click()
