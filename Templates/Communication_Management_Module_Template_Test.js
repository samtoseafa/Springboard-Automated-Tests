...
it("Communications Management Module Check", function () {
    cy.get('[style="width: 320px; height: 200px; padding: 20px; border-radius: 20px; text-align: center; background-color: rgb(237, 194, 28);"]').click()
